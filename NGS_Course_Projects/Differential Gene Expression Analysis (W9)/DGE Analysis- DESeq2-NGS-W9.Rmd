...
plot_ct=plotCounts(dds, gene='Pdac_HC_chr14G0028200', intgroup="condition", 
                returnData=TRUE)
```
```{r}
plot_ct
...
```{r}
res.shrunk <- lfcShrink(dds, contrast = c('condition','lowSucrose','highSucrose'),type='normal' )
```

```{r}
res.shrunkOrdered <- res.shrunk
```
...
### Q4.1 
```{r}
#Subset the table with “shrunken” log2 fold-change estimates 
```
